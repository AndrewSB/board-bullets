    ...
    @IBAction func signupButtonHit() {
        ...
        user.signUpInBackgroundWithBlock { (user, error) in
            ...
            if error == nil {
                ...
                errorMessage = errorMessage.stringByReplacingOccurrencesOfString("username", withString: "email", options: [], range: Range(start: errorMessage.startIndex, end: errorMessage.endIndex))
